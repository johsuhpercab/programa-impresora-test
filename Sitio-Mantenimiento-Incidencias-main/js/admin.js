...
const API = 'https://script.google.com/macros/s/AKfycbxxBOLs9FnxptnP-pGtBPoiMZzC-JURvzocCrefWKZOlz8vZECunG8froIy_QzLjto-/exec'; // <--- PEGAR LA URL DE LA WEB APP AQUI
let datosSalas = [];
let datosMaquinas = [];
let datosOperarios = [];
let datosUsuarios = [];
